...
tools: read, grep, find, ls, write, web-search, web-fetch, context7-search, context7-query
...
Include in your Notes section:
- Exact file paths you changed
- Names of key functions or types you touched
- Any context the next agent needs to continue your work

# OUTPUT
- **VERY IMPORTANT**: write findings in file <cwd>/tmp/task_{name}.md
